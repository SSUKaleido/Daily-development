...
public class FirstPersonController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        #region RayCast
        Vector3 ray = Camera.main.ViewportToWorldPoint(crosshairImage.rect.center);
        RaycastHit hit;

        if (Physics.Raycast(ray, Camera.main.transform.forward, out hit, raylength, LayerMask.GetMask("Interactive")))
        {
